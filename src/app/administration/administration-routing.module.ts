...
import { EditGalleryItemComponent } from './gallery/edit-gallery-item/edit-gallery-item.component';
...
import { WhyChooseUsTableComponent } from './why-choose-us/why-choose-us-table/why-choose-us-table.component';
import { AddWhyChooseUsComponent } from './why-choose-us/why-choose-us.component';
...
const routes: Routes = [
  {
    path: '', component: LayoutComponent, children: [
      ...
      { path: 'edit-gallery-item/:id', component: EditGalleryItemComponent },
      ...
      { path: 'my-sites', component: SitesTableComponent },
      { path: 'add-team-member', component: AddTeamMemberComponent },
      { path: 'edit-team-member/:id', component: AddTeamMemberComponent },
